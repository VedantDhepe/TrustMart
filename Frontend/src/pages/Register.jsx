  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-blue-100 via-pink-100 to-purple-200">
      ...
      >
        ...
        />
        {errors.name && (
          <div className="text-red-500 text-xs mb-4">{errors.name}</div>
        )}
        <input
          type="text"
          name="email"
        ...
        />
        {errors.address && (
          <div className="text-red-500 text-xs mb-4">{errors.address}</div>
        )}
        <input
          type="password"
          name="password"
        ...
        />
        {
          <div className="text-yellow-500 text-xs mb-4">
            {" "}
            Password : minimum 1 Uppercase, symbol and number
          </div>
        }
        {errors.password && (
        ...
        <button
          type="submit"
          disabled={loading}
          className={`w-full py-3 bg-gradient-to-r from-blue-400 via-pink-400 to-purple-400 text-white font-bold rounded-lg shadow-lg transition flex items-center justify-center ${loading ? "opacity-60 cursor-not-allowed" : "hover:from-blue-500 hover:to-purple-500"}`}
        >
          {loading ? (
            <>
              <svg
